		...
		<nav id="navbar" class="navbar fixed-top navbar-expand-lg navbar-header navbar-mobile">
			<div class="navbar-container container">
				...
				<a class="navbar-brand-logo" href="#">
					<img src="public\assets\images\logo.png" width="155px">
				</a>
				</div>
		...
		<div class="wrapper">
			<div class="header">
				<div class="container header-container">
					<div class="col-lg-6 header-img-section">
						<img src="public\assets\images\header.png">
					</div>
			...
			<div class="strategy-section">
				<div class="strategy-section-bg-graphics-section">
					<img src="public\assets\images\strategy-section-bg.png">
				</div>
				<div class="container strategy-container">
					<div class="col-lg-3 col-md-6 col-xs-8 offset-xs-2 strategy-card-section">
						<div class="strategy-card">
							<div class="strategy-card-icon-section">
								<img src="public\assets\images\strategy-1.png">
							</div>
							<h2>Strategy</h2>
					...
					<div class="col-lg-3 col-md-6 col-xs-8 offset-xs-2 strategy-card-section">
						<div class="strategy-card">
							<div class="strategy-card-icon-section">
								<img src="public\assets\images\strategy-2.png">
							</div>
							<h2>Automation</h2>
					...
					<div class="col-lg-3 col-md-6 col-xs-8 offset-xs-2 strategy-card-section">
						<div class="strategy-card">
							<div class="strategy-card-icon-section">
								<img src="public\assets\images\strategy-3.png">
							</div>
							<h2>Deployment</h2>
					...
					<div class="col-lg-3 col-md-6 col-xs-8 offset-xs-2 strategy-card-section">
						<div class="strategy-card">
							<div class="strategy-card-icon-section">
								<img src="public\assets\images\strategy-4.png">
							</div>
							<h2>Education</h2>
			...
			<div class="services-section">
				<div class="services-section-bg-graphics">
					<img src="public\assets\images\services-section-bg.png">
				</div>
				<div class="container services-container">
					...
					<div class="col-lg-6 offset-lg-1 services-header-img-section">
						<img src="public\assets\images\services-header.png">
					</div>
				</div>
			</div>
			<!-- SALES GROWTH -->
			<div class="services-sales-section">
				<div class="container services-container">
					<div class="col-lg-6 services-header-img-section padding-0">
						<img src="public\assets\images\services-sales-header.png">
					</div>
			...
			<div class="pricing-section">
				<div class="pricing-section-left-bg-graphics">
					<img src="public\assets\images\pricing-section-left-bg.png">
				</div>
				<div class="pricing-section-right-bg-graphics">
					<img src="public\assets\images\pricing-section-right-bg.png">
				</div>
			...
			<div class="blog-section">
				<div class="blog-section-right-bg">
					<img src="public\assets\images\blog-section-right-bg.png">
				</div>
				<div class="blog-section-left-bg">
					<img src="public\assets\images\blog-section-left-bg.png">
				</div>
				<div class="container blog-container">
					...
					<div class="blog-posts-section">
						<div class="col-lg-4 col-md-8 col-xs-10 blog-post-card-container">
							<div class="blog-post-card">
								<div class="blog-post-icon">
									<img src="public\assets\images\blog-card-1.png">
								</div>
						...
						<div class="col-lg-4 col-md-8 col-xs-10 blog-post-card-container">
							<div class="blog-post-card">
								<div class="blog-post-icon mb-4">
									<img src="public\assets\images\blog-card-2.png">
								</div>
						...
						<div class="col-lg-4 col-md-8 col-xs-10 blog-post-card-container">
							<div class="blog-post-card">
								<div class="blog-post-icon">
									<img src="public\assets\images\blog-card-3.png">
								</div>
			...
			<div class="contact-section">
				<div class="container contact-container">
					...
					<div class="col-md-6 contact-header-img">
						<img src="public/assets/images/contact-header-img.png">
					</div>
				</div>
			</div>
			<!-- FOOTER -->
			<div class="footer-section">
				<div class="footer-section-bg-graphics">
					<img src="public\assets\images\footer-section-bg.png">
				</div>
                <!-- Footer Column 1 -->
				<div class="container footer-container">
					<div class="col-lg-3 col-md-6 footer-logo">
						<img src="public\assets\images\logo_footer.png">
